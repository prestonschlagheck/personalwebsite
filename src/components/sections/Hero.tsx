...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 bg-neutral-900 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-start gap-6">
            <motion.h1
              ...
              className="text-5xl md:text-7xl font-extrabold text-white tracking-tight text-left"
            >
              Preston Schlagheck
            </motion.h1>
            <motion.p
              ...
              className="text-sm md:text-base text-neutral-200 font-medium text-left"
            >
            ...
            <motion.p
              ...
              className="text-xs text-neutral-400 mb-2 text-left"
            >
